...
class VuePluginBoilerplate {
  constructor() {
    return ['ui.router', 'ui.bootstrap', 'ui.bootstrap.popover', 'ngAnimate', 'guanlecoja.ui', 'bbData'];
  }
}
...
class VuePluginBoilerplateController {
  constructor($scope, $element, $q, $window, dataService, bbSettingsService, resultsService, $uibModal, $timeout) {
...
angular.module('buildbot_vue_plugin_boilerplate', new VuePluginBoilerplate()).config(['$stateProvider', 'glMenuServiceProvider', 'bbSettingsServiceProvider', 'config', VuePluginBoilerplateConfig]).controller('VuePluginBoilerplateController', ['$scope', '$element', '$q', '$window', 'dataService', 'bbSettingsService', 'resultsService', '$uibModal', '$timeout', VuePluginBoilerplateController]);
